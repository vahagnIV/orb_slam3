...
namespace orb_slam3 {
namespace camera {
Barrel5::Barrel5() : k1_(0), k2_(0), p1_(0), p2_(0), k3_(0) {

}

Barrel5::Barrel5(std::istream &istream, serialization::SerializationContext &context) {
...
void Barrel5::ComputeGradientAndHessian(const HomogenousPoint &point, TVector3D &out_gradient, TMatrix33 &out_hessian) {
