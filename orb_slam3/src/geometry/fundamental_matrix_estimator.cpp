...
void FundamentalMatrixEstimator::FindFundamentalMatrix(const std::vector<TPoint2D> & kp1,
                                                 const std::vector<TPoint2D> & kp2,
...
void FundamentalMatrixEstimator::FindBestFundamentalMatrix(const std::vector<TPoint2D> & kp1,
                                                     const std::vector<TPoint2D> & kp2,
                                                     const std::vector<std::pair<size_t, size_t>> & good_matches,
