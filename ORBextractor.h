...
class ORBextractor {
 public:
  ...
  double inline GetLogScaleFactor() const {
    return logScaleFactor;
  }

  inline const std::vector<float> &GetScaleFactors() const {
    return mvScaleFactor;
  }

  inline const std::vector<float> &GetInverseScaleFactors() const {
    return mvInvScaleFactor;
  }

  inline const std::vector<float> &GetScaleSigmaSquares() const {
